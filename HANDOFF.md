...
| production bundle | `index-BpK0Pnqh.js` (+ `index-BWgKdWiq.css`) |
...
| pending deploy | none — production serves this branch's tip (verified live: the translate demo's excerpt card sits 12px from the top of a tall card) |
