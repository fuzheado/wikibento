...
| production bundle | `index-CF0eBcoA.js` (+ `index-BWgKdWiq.css`) |
| deployed | 2026-09-16 — **click-through from a box** (ISSUE-91), **Wikipedia boxes** (ISSUE-90), **compressed share links** (ISSUE-89) and **borrowed boards** (ISSUE-88); before that, 2026-09-15 seven times |
...
| pending deploy | none — production serves this branch's tip (verified live: clicking "Weddell Sea" in the seas box loaded the article in the page viewer and the string in the value card) |
