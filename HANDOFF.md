...
| production bundle | `index-Ckn8aPWg.js` (+ `index-BWgKdWiq.css`) |
| deployed | 2026-09-16 — **references everywhere** (ISSUE-92), the **Article Excerpt's two channels** and text gravity (ISSUE-94), **click-through from a box** (ISSUE-91), **Wikipedia boxes** (ISSUE-90), **compressed share links** (ISSUE-89) and **borrowed boards** (ISSUE-88); before that, 2026-09-15 seven times |
...
| pending deploy | none — production serves this branch's tip (verified live: the served manifest declares the excerpt's `extract`+`reference` channels) |
