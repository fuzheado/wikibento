...
| production bundle | `index-DTO6rAQ8.js` (+ `index-BWgKdWiq.css`) |
| deployed | 2026-09-16 — **references** (ISSUE-92), **click-through from a box** (ISSUE-91), **Wikipedia boxes** (ISSUE-90), **compressed share links** (ISSUE-89) and **borrowed boards** (ISSUE-88); before that, 2026-09-15 seven times |
...
| pending deploy | none — production serves this branch's tip (verified live: a box published `enwiki:Weddell Sea` and the page viewer resolved it to the English article) |
