...
| production bundle | `index-TPEFE8Mw.js` (+ `index-BWgKdWiq.css`) |
| deployed | 2026-09-16 — **one picker for every wiki** (ISSUE-93), **references everywhere** (ISSUE-92), text gravity (ISSUE-94), **click-through from a box** (ISSUE-91), **Wikipedia boxes** (ISSUE-90), **compressed share links** (ISSUE-89) and **borrowed boards** (ISSUE-88); before that, 2026-09-15 seven times |
