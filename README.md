...
| 📖 [Internet Archive](https://wikibento.toolforge.org/?config=/internet-archive-demo.json) | a scanned book you can turn, zoom and **search inside** (16 pages, and a 304-page Dostoevsky), plus archive items for the media types the next cards will play |
