...
/** Timeline — dated rows as lanes on one shared axis (ISSUE-78).
 *
...
/** IA Book — a scanned Internet Archive book, read in the shared paged viewer.
 *
 *  The viewer itself (turn, zoom, strip, counter, search, facing pages, right-to-left) lives in
 *  ./PagedViewer.jsx and knows nothing about archives; this card supplies what is archive-specific: the
